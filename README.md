...
Integration with **my framework** providing windowing, input, file I/O, logging, OpenGL video output, and general platform abstraction. I did not write one line of code in the petemu folder. It was all generated by ChatGPT prompts.
