...
private:
	...
	// Folder helpers
	bool buildDirectoryPRG_Folder(std::vector<uint8_t>& out, uint16_t startAddr = 0x0401);
	...
	bool buildDirectoryPRG_D64(std::vector<uint8_t>& out, uint16_t startAddr = 0x0401);
